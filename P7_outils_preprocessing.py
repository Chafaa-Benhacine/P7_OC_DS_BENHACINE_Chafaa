...
# Version : 0.0.0 - CRE LR 12/10/2021
# ====================================================================
...
def reduce_mem_usage(data, verbose=True):
    ...
    if verbose:
        print('_' * 79)
        print('\nMemory usage of dataframe: {:.2f} MB'.format(start_mem))
...
def feature_engineering_neighbors_EXT_SOURCE(dataframe):
    ...
    with open('OUTPUT_DATA/TARGET_MEAN_500_Neighbors_training_data.pkl', 'wb') as f:
    ...
    with open('OUTPUT_DATA/KNN_model_TARGET_500_neighbors.pkl', 'wb') as f:
         pickle.dump(knn, f)
...
def features_selection_boruta(dataframe, titre):
    ...
    fic_sav_fs_boruta = \
        'OUTPUT_DATA/features-selection/' + titre + '.pickle'
